...
class ConvTranspose1d():
    ...
    def forward(self, A):
        ...
        # A_upsampled : (batch_size, in_channels, input_size + (input_size - 1) * upsampling_factor)
        # Call Conv1d_stride1()
    ...
    def backward(self, dLdZ):
        ...
        dLdA_upsampled = self.conv1d_stride1.backward(dLdZ)
        # dLdA_upsampled : (batch_size, in_channels, input_size + (input_size - 1) * upsampling_factor)
        
        # Adjust gradient for upsampling
        input_size = dLdA_upsampled.shape[2]
        dLdA = dLdA_upsampled[:, :, :input_size:self.upsampling_factor]
