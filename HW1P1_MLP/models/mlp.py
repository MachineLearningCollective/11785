...
class MLP1:
    ...
    def forward(self, A0):
        ...
        """
        linear_layer1 = self.layers[0]
        relu_activation1 = self.layers[1]

        Z0 = linear_layer1.forward(A0)
        A1 = relu_activation1.forward(Z0)

        linear_layer2 = self.layers[2]
        relu_activation2 = self.layers[3]
        Z1 = linear_layer2.forward(A1)
        A2 = relu_activation2.forward(Z1)
